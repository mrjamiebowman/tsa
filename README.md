...
*	TSA PreCheck - Fast scan to ensure essential config values are present (like connection strings, secrets, ports, etc).
...
Carry-On – Safe default settings the app can carry along.
